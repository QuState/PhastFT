...
//!
use core::f32;
use std::simd::{f32x16, f32x4, f32x8, f64x4, f64x8, StdFloat};
...
pub fn fft_dit_chunk_8_simd_f64(reals: &mut [f64], imags: &mut [f64]) {
    ...
    reals
        ...
        .for_each(|(reals_chunk, imags_chunk)| {
            ...
            out0_re.copy_to_slice(reals_s0);
            out0_im.copy_to_slice(imags_s0);
            out1_re.copy_to_slice(reals_s1);
            out1_im.copy_to_slice(imags_s1);
        });
}
...
pub fn fft_dit_chunk_32_simd_f64(reals: &mut [f64], imags: &mut [f64]) {
    ...
    reals
        ...
        .for_each(|(reals_chunk, imags_chunk)| {
            ...
            let twiddle_re_part_0_7 =
                twiddle_re_0_7.mul_add(in1_re_0_7, -(twiddle_im_0_7 * in1_im_0_7));
            let twiddle_im_part_0_7 =
                twiddle_re_0_7.mul_add(in1_im_0_7, twiddle_im_0_7 * in1_re_0_7);
            ...
            out0_re_0_7.copy_to_slice(&mut reals_s0[0..8]);
            out0_im_0_7.copy_to_slice(&mut imags_s0[0..8]);
            out1_re_0_7.copy_to_slice(&mut reals_s1[0..8]);
            out1_im_0_7.copy_to_slice(&mut imags_s1[0..8]);
            ...
            let twiddle_re_part_8_15 =
                twiddle_re_8_15.mul_add(in1_re_8_15, -(twiddle_im_8_15 * in1_im_8_15));
            let twiddle_im_part_8_15 =
                twiddle_re_8_15.mul_add(in1_im_8_15, twiddle_im_8_15 * in1_re_8_15);
            ...
            out0_re_8_15.copy_to_slice(&mut reals_s0[8..16]);
            out0_im_8_15.copy_to_slice(&mut imags_s0[8..16]);
            out1_re_8_15.copy_to_slice(&mut reals_s1[8..16]);
            out1_im_8_15.copy_to_slice(&mut imags_s1[8..16]);
        });
}
...
pub fn fft_dit_chunk_64_simd_f64(reals: &mut [f64], imags: &mut [f64]) {
    ...
    reals
        ...
        .for_each(|(reals_chunk, imags_chunk)| {
            ...
            out0_re.copy_to_slice(&mut reals_s0[0..8]);
            out0_im.copy_to_slice(&mut imags_s0[0..8]);
            out1_re.copy_to_slice(&mut reals_s1[0..8]);
            out1_im.copy_to_slice(&mut imags_s1[0..8]);
            ...
            out0_re.copy_to_slice(&mut reals_s0[8..16]);
            out0_im.copy_to_slice(&mut imags_s0[8..16]);
            out1_re.copy_to_slice(&mut reals_s1[8..16]);
            out1_im.copy_to_slice(&mut imags_s1[8..16]);
            ...
            out0_re.copy_to_slice(&mut reals_s0[16..24]);
            out0_im.copy_to_slice(&mut imags_s0[16..24]);
            out1_re.copy_to_slice(&mut reals_s1[16..24]);
            out1_im.copy_to_slice(&mut imags_s1[16..24]);
            ...
            out0_re.copy_to_slice(&mut reals_s0[24..32]);
            out0_im.copy_to_slice(&mut imags_s0[24..32]);
            out1_re.copy_to_slice(&mut reals_s1[24..32]);
            out1_im.copy_to_slice(&mut imags_s1[24..32]);
        });
}
...
pub fn fft_dit_chunk_64_simd_f32(reals: &mut [f32], imags: &mut [f32]) {
    ...
    reals
        ...
        .for_each(|(reals_chunk, imags_chunk)| {
            ...
            out0_re.copy_to_slice(&mut reals_s0[0..16]);
            out0_im.copy_to_slice(&mut imags_s0[0..16]);
            out1_re.copy_to_slice(&mut reals_s1[0..16]);
            out1_im.copy_to_slice(&mut imags_s1[0..16]);
            ...
            out0_re.copy_to_slice(&mut reals_s0[16..32]);
            out0_im.copy_to_slice(&mut imags_s0[16..32]);
            out1_re.copy_to_slice(&mut reals_s1[16..32]);
            out1_im.copy_to_slice(&mut imags_s1[16..32]);
        });
}
        ...
        .for_each(|(reals_chunk, imags_chunk)| {
            ...
            reals_s0
                ...
                .for_each(|(((((re_s0, re_s1), im_s0), im_s1), w_re), w_im)| {
                    let in0_re = f64x8::from_slice(re_s0);
                    let in1_re = f64x8::from_slice(re_s1);
                    let in0_im = f64x8::from_slice(im_s0);
                    let in1_im = f64x8::from_slice(im_s1);

                    let tw_re = f64x8::from_slice(w_re);
                    let tw_im = f64x8::from_slice(w_im);

                    // Apply twiddle factors with FMA (tw_im is pre-negated)
                    ...
                    out0_re.copy_to_slice(re_s0);
                    out0_im.copy_to_slice(im_s0);
                    out1_re.copy_to_slice(re_s1);
                    out1_im.copy_to_slice(im_s1);
                });
        });
}
    ...
    reals
        ...
        .for_each(|(reals_chunk, imags_chunk)| {
            ...
            reals_s0
                ...
                .zip(twiddles_im.chunks_exact(LANES))
                .for_each(|(((((re_s0, re_s1), im_s0), im_s1), w_re), w_im)| {
                    let in0_re = f32x16::from_slice(re_s0);
                    let in1_re = f32x16::from_slice(re_s1);
                    let in0_im = f32x16::from_slice(im_s0);
                    let in1_im = f32x16::from_slice(im_s1);
